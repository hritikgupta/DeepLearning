...
trainset = ListDataset(root='images/training', list_file='labels/training.txt', train=True, transform=transform)
trainloader = torch.utils.data.DataLoader(trainset, batch_size=20, shuffle=True, num_workers=3)

testset = ListDataset(root='images/testing', list_file='labels/testing.txt', train=False, transform=transform)
